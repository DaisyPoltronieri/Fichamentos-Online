...
\[**Pontuações:** Primeira menção do conceito de *conatus* no corpo do texto e exprimindo uma razão para sua abordagem. Para Leibniz o corpo e o *conatus* compartilham do mesmo plano, quero dizer que eles são concomitantes e existem ao mesmo tempo. Ele diz que a extensão é central para se extrair as conjecturas sobre o objeto: corpo, espaço, movimento e tempo - *conatus*, o instante e o ponto]. Todas as complexidades compartilham a noção de extensão. Pensar que são inexistentes é um absurdo, portanto, o que não se extrai diretamente da extensão tem que ser inextenso - diferentemente de inexistente].
